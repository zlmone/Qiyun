<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpspace\learning\phpweb\thinkphp\public/../application/root\view\index\add.htm";i:1522462949;s:76:"D:\phpspace\learning\phpweb\thinkphp\application\root\view\common\header.htm";i:1522422970;s:74:"D:\phpspace\learning\phpweb\thinkphp\application\root\view\common\left.htm";i:1522422706;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">管理员</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="pwd" placeholder="" name="pwd" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="confir_pwd" class="col-sm-2 control-label no-padding-right">确认密码</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="confir_pwd" placeholder="" name="confir_pwd" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
